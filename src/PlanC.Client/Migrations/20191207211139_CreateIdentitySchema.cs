        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GVN_NM = table.Column<string>(maxLength: 50, nullable: true),
                    SNM = table.Column<string>(maxLength: 50, nullable: true),
                    RCD_CDTTM = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
