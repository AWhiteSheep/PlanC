...
namespace PlanC.Client.Migrations
{
    ...
    [Migration("20191206123148_CreateIdentitySchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanC.EntityDataModel.Roles", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnName("ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlanC.EntityDataModel.RolesUtilisateur", b =>
                {
                    ...
                    b.HasAlternateKey("RoleId", "UtilisateurId");

                    b.ToTable("RolesUtilisateur");
                });
            ...
            modelBuilder.Entity("PlanC.EntityDataModel.RolesUtilisateur", b =>
                {
                    b.HasOne("PlanC.EntityDataModel.Roles", "Role")
                        .WithMany("RolesUtilisateur")
                        .HasForeignKey("RoleId")
                        .HasConstraintName("FK_TUSERROLE_TROLE")
                        .IsRequired();

                    b.HasOne("PlanC.EntityDataModel.Utilisateurs", "Utilisateur")
                        .WithMany("RolesUtilisateur")
