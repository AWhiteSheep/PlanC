...
namespace PlanC.Client.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {     
            ...
            [Required(ErrorMessage = "Vous devez saisir une clé d'enregistrement.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Utilisateurs { UserName = Input.Email, Id = Input.Id, DepartementId = Input.DepartementId, 
